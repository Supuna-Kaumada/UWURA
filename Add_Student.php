...
<div style="border:thin" col-2>
	<form class="w3-container w3-light-grey" action="A_Pass-std.php" method="post">
  <div >
  <br>
    <p>
    <label for="textfield">RegNo:</label>
    <input type="text" class="w3-input w3-border-0" name="personID" id="personID" placeholder="Enter Registration No." pattern="[A-Za-z]{3}[0-9]{5}" required>
    ...
    <p>
    <label for="textfield5">Degree:</label>
