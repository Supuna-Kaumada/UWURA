...
$query   = "INSERT into person (personID,category,firstname,lastname,email,password,mobile1,mobile2,degreeID,hash) VALUES('".$id."','".$category."','".$firstName."','".$lastName."','".$email."','".$password."','".$mobile1."','".$mobile2."','".$departmentID."','".$hash."')";
...
?>
  ...
  class="w3-button w3-red w3-large w3-display-topright">&times;</span>
   ...
   <?php
        ...
        https://uwura.000webhostapp.com/verify.php?email='.$email.'&hash='.$hash;  
