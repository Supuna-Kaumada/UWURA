...
$query   = "INSERT into person (personID,category,firstname,lastname,email,password,mobile1,mobile2,hash) VALUES('".$id."','".$category."','".$firstName."','".$lastName."','".$email."','".$password."','".$mobile1."','".$mobile2."','".$hash."')";
