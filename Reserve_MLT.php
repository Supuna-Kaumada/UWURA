...
<h1 align="center">Main Lecture Theatre Reservation
...
<div style="border:thin" col-2>
    ...
    <form class="w3-container w3-light-grey" name="ReservationInputMLT"  method="POST">
    	<br>      
      <label for="textfield">Select date:</label>
        ...
        <br>
        <input type="button" class="w3-button w3-orange" name="getTimeTable" onclick="getTimeTableMLT();" value="Get Time Table">
    ...
    <div class="col-sm-6">
 	...
 	<script>
        function forwardMLT(){
            document.forms['ReservationInputMLT'].action = 'http://localhost/PassMLTReservations.php';
            document.forms['ReservationInputMLT'].submit();
			document.forms['ReservationInputMLT'].target = 'tt';
            document.forms['ReservationInputMLT'].reset();
            }
    </script>
    
     <script>
		function getTimeTableMLT(){
			document.forms['ReservationInputMLT'].action = 'http://localhost/TimeTableMLT.php';
			document.forms['ReservationInputMLT'].target = 'tt';
			document.forms['ReservationInputMLT'].submit();
			}
	</script>
