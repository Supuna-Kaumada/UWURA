...
$query   = "INSERT into person (personID,category,firstname,lastname,email,password,mobile1,mobile2,departmentID,hash) VALUES('".$id."','".$category."','".$firstName."','".$lastName."','".$email."','".$password."','".$mobile1."','".$mobile2."','".$departmentID."','".$hash."')";
...
?>
  ...
  class="w3-button w3-red w3-large w3-display-topright">&times;</span>
				<h3>Confirm Email!</h3>
				<p>Check your e-mail to activate the account
				<br>
   ...
   <?php
	//mail;
        ...
        http://uwura.000webhostapp.com/verify.php?email='.$email.'&hash='.$hash;  
