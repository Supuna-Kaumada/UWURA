...
<img src="assets/img/hall.png" width="250" height="250">
<br>
</div>
...
<form action="PassHall.php" class="w3-container w3-light-grey" method="post">
	...
	$sql = "SELECT * FROM resource WHERE resourcecategory='Hall'";
    ...
    <input type="submit" name="submit" id="submit" value="Add Hall" class="w3-btn w3-orange">
  </form>
