...
<h1 align="center">General Admin Registration</h1>
...
<div style="border:thin" col-2>
	<form class="w3-container w3-light-grey" action="A_Pass-adm.php" method="post">
  <div >
  <br>
    <p>
    <label for="textfield">General Admin ID:</label>
    <input type="text" class="w3-input w3-border-0" name="personID" id="personID" placeholder="Enter General Admin ID." pattern="[A-Za-z]{3}[0-9]{5}" required>
    ...
    <input type="password" class="w3-input w3-border-0" name="cpassword" id="cpassword" placeholder="Enter Password" oninvalid="setCustomValidity('Password must contain atleast 8 characters')" onchange="try{setCustomValidity('')}catch(e){}" required>
    </p>
